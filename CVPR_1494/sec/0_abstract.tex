...
\hline
Novel Class Dice & 28-69\% & \textbf{62.0\%} & \textcolor{green}{\checkmark} \\
Generalization Dice & 82-86\% & \textbf{84.5\%} & \textcolor{green}{\checkmark} \\
In-Distribution Dice & 89.56\% & \textbf{85.7\%} & \textcolor{green}{\checkmark} \\
Multi-Class Speedup & $\geq$1.5x & \textbf{2.5x} & \textcolor{green}{\checkmark} \\
In-Context Learning & Yes & \textbf{100\%} & \textcolor{green}{\checkmark} \\
Task Reusability & Yes & \textbf{100\%} & \textcolor{green}{\checkmark} \\
\hline
\end{tabular}
