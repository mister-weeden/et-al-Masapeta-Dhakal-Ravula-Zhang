...
Our results demonstrate performance competitive with recent universal segmentation approaches~\cite{liu2023clip,ye2023uniseg} and exceed baseline performance for novel class scenarios in medical imaging.
